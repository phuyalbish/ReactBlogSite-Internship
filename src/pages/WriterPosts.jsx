    ...
    <section className="posts">
        ...
        <div className="writerInfo-container">
           ...
           <div className="visitbuttons">
             <Link to={`mailto:${writer.username}`}  target="_blank"><button className='btn primary'> Mail {writer.username}</button></Link>
            <Link to={`https://www.${writer.website}`} target="_blank"><button className='btn primary'> Visit Site  <FaExternalLinkAlt/></button></Link>
